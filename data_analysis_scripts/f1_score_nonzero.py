...
def plot_f1_by_model(model_metrics: pd.DataFrame, output_dir: Path):
    ...
    ax.set_ylabel('Score')
    ax.set_title('F1 Score, Precision, and Recall by Model (IoU > 0)')
    ax.set_xticks(index)
...
def plot_f1_by_sequence(sequence_metrics: pd.DataFrame, output_dir: Path):
    ...
    ax.set_title('F1 Score by Sequence and Model (IoU > 0)')
    ax.set_xticks(index)
...
def plot_f1_by_day_night(day_night_metrics: pd.DataFrame, output_dir: Path):
    ...
    ax.set_ylabel('F1 Score')
    ax.set_title('F1 Score by Day/Night Conditions (IoU > 0)')
    ax.set_xticks(index)

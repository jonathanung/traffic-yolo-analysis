...
output_dir = PROJECT_ROOT / 'results/yolov3'
test_sets = ['daySequence1', 'daySequence2', 'nightSequence1', 'nightSequence2']
model_weights = PROJECT_ROOT / 'models/yolov3/runs/train/lisa_traffic_light/weights/best.pt'
fallback_weights = PROJECT_ROOT / 'models/yolov3/weights/yolov3.pt'
...
def main():
    ...
    yolov3_path = str(PROJECT_ROOT / 'models/yolov3')
    ...
    try:
        ...
        print(f"Make sure the YOLOv3 repository is in {yolov3_path}")
        return

...
output_dir = 'results/yolov5'
test_sets = ['daySequence1', 'daySequence2', 'nightSequence1', 'nightSequence2']
conf_thresh = 0.25 
iou_thresh = 0.45
model_weights = 'models/yolov5/runs/train/lisa_traffic_light/weights/best.pt'
fallback_weights = 'models/yolov5/weights/yolov5s.pt'
...
def main():
    ...
    yolov5_path = str(Path('models/yolov5').absolute())
    ...
    try:
        ...
        print(f"Make sure the YOLOv5 repository is in models/yolov5")
        return
